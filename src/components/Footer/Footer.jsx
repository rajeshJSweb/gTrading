...
const Footer = () => {
    return (
        <div className='flex justify-between my-10 mx-24'>
            <div className='w-4/12 flex flex-col gap-5'>
                <h1 className='text-[70px] text-purple-700 font-semibold'>G<span className='text-[30px] text-slate-500'>trading</span></h1>
                <h2 className='text-left text-xl font-semibold text-slate-700'>Stay tuned</h2>
                <form className='flex flex-col gap-5' action="">
                    <input className='w-10/12 outline-none border-b-2 mt-5 border-slate-200 p-2' placeholder='Email address' type="email" />
                    <input className='bg-purple-700 text-xl font-semibold text-white px-5 py-2 w-10/12' type="submit" value="Subscribe Now" />
                </form>
            </div>
            <div className='w-4/12 flex gap-5'>
                
                <div className='w-8/12 flex flex-col gap-1'>
                <h1 className='text-xl text-slate-900 font-semibold border-b-2'>Service</h1>
                ...
                <div className='w-4/12 flex flex-col gap-1'>
                    <h1 className='text-xl text-slate-900 font-semibold border-b-2'>About Us</h1>
                    <Link>About Us</Link>
                    <Link>Contact</Link>
                    <Link>Location</Link>
            ...
            <div className='w-4/12 flex justify-center'>
                <div>
                    <h1 className='text-xl font-semibold text-slate-900 border-b-2 border-slate-500'>Follow</h1>
                    <div className='flex gap-3 my-5 text-3xl'>
