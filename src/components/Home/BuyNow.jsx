...
const BuyNow = () => {
  ...
  const convertCurrency = (amount, fromCurrency, toCurrency) => {
    ...
    if (fromCurrency === "BTC" && toCurrency === "USD") {
      ...
      convertAmount = amount * 0.3936;
    } else if (fromCurrency === "USDC" && toCurrency === "EUR") {
      convertAmount = amount * 200.5;
    } else if (fromCurrency === "ETH" && toCurrency === "EUR") {
      convertAmount = amount * 9523.5;
    } else {
  ...
  return (
    <div className=" bg-slate-100 py-10 md:flex px-2">
      <div className="md:w-4/12 md:mx-20 py-10 rounded-xl bg-white flex flex-col gap-10 shadow-xl mb-14 md:mb-0">
        <form className="flex flex-col items-center gap-14" action="">
          <div className="w-full flex justify-evenly">
            ...
            >
              <option value="BTC">
                <FaBitcoin className="border-2 border-red-500 bg-orange-600 h-[20px] w-[20px]"></FaBitcoin>
                BTC
              </option>
          ...
          <div className="w-full px-10">
            <button className="w-full bg-purple-600 py-3 rounded-xl text-xl font-semibold text-white">
              Buy Now
            </button>
          </div>
        </form>
      ...
      <div className="flex flex-col justify-evenly">
        <h1 className="text-2xl lg:text-4xl font-semibold text-slate-600">
        ...
        <div>
          ...
          <p className="text-slate-500 text-[14px] lg:text-lg">
            Become a crypto owner in minutes using your debit or credit card.
          </p>
        </div>
        <div>
          <h3 className="lg:text-2xl text-lg font-semibold text-slate-500">
